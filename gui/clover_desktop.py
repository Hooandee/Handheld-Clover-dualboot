...
STRINGS = {
    "es": {
        ...
        "confirm_repair_boot": "Se registrará Clover si falta, se moverá al primer puesto y se preparará como próximo arranque conservando todas las entradas UEFI. ¿Continuar?",
        "ok_repair_boot": "Prioridad y próximo arranque reparados y verificados.",
    ...
    "en": {
        ...
        "confirm_repair_boot": "Clover will be registered if missing, moved first and armed as the next boot while preserving every UEFI entry. Continue?",
        "ok_repair_boot": "Boot priority and next boot repaired and verified.",
